...
MANUAL_DAU_OVERRIDE = 11016                      # Change this to control "Daily Active Users"
MANUAL_AVG_DAU_CEILING = 10993                  # Change this to directly set AVG_DAU_CEILING (optional)
...
def traction_analytics():
    ...
    st.caption(f"Historical growth curve tracking last updated at 1:30 PM.")
    ...
    original_proportions = np.array([0.13599, 0.10965, 0.10526, 0.12719, 0.13596, 0.11842, 0.15351, 0.11404])
