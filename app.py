...
MANUAL_DAU_OVERRIDE = 9300                      # Change this to control "Active Users (Live)"
...
def traction_analytics():
    ...
    if manual_status:
        st.caption(f"Historical growth curve last updated at 7:13 AM. Live DAU tracks this line.")
    else:
