...
MANUAL_MAX_REGISTERED_USERS = 11078              # Change this to override MAX_REGISTERED_USERS
MANUAL_DAU_OVERRIDE = 10915                      # Change this to control "Daily Active Users"
MANUAL_AVG_DAU_CEILING = 10893                  # Change this to directly set AVG_DAU_CEILING (optional)
...
def traction_analytics():
    ...
    st.caption(f"Historical growth curve tracking last updated at 4:30 PM.")
