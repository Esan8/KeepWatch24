...
MANUAL_DAU_OVERRIDE = 9883                      # Change this to control "Active Users (Live)"
MANUAL_AVG_DAU_CEILING = 9896                  # Change this to directly set AVG_DAU_CEILING (optional)
...
def traction_analytics():
    ...
    if manual_status:
        st.caption(f"Historical growth curve last updated at 4:31 PM. Live DAU tracks this line.")
    else:
