...
MANUAL_MAX_REGISTERED_USERS = 9896              # Change this to override MAX_REGISTERED_USERS
MANUAL_DAU_OVERRIDE = 9588                      # Change this to control "Active Users (Live)"
MANUAL_AVG_DAU_CEILING = 9799                   # Change this to directly set AVG_DAU_CEILING (optional)
...
def traction_analytics():
    ...
    if manual_status:
        st.caption(f"Historical growth curve last updated at 2:10 PM. Live DAU tracks this line.")
    else:
        st.caption(f"Historical growth curve from {DAU_START_DATE_STR} to {DAU_END_DATE_STR}.")

    # --- Prayer Watch Engagement (Dynamic) ---
