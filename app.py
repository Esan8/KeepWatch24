...
MANUAL_MAX_REGISTERED_USERS = 9826              # Change this to override MAX_REGISTERED_USERS
MANUAL_DAU_OVERRIDE = 9115                      # Change this to control "Active Users (Live)"
MANUAL_AVG_DAU_CEILING = 9528                   # Change this to directly set AVG_DAU_CEILING (optional)
...
def traction_analytics():
    ...
    if manual_status:
        st.caption(f"Historical growth curve last updated at 11:51 AM. Live DAU tracks this line.")
    else:
