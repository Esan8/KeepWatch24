...
MANUAL_END_DATE_STR = "2026-01-13"   # Anchor point for the chart
MANUAL_OBSERVED_DAU = 12760          # Enter your real number here to compare vs. Anchor
...
if __name__ == "__main__":
    main()        users_list = st.secrets["auth"]["users"]
